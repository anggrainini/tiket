...
<html lang="en">
	...
	<a href="<?php echo base_url(); ?>admin/tambah_operator" class="btn btn-success btn-xs" role="button">Add Operator <span class="glyphicon glyphicon-plus"></span></a>
		...
		?>
											...
											<tbody>
												<tr>
													...
													<td>
														<?php echo $op['id_operator']; ?>
													</td>
													<td><?php echo $op['password']; ?></td>
													<td><?php echo $op['nama']; ?></td>
													<td align="left"><?php echo $op['no_hp']; ?></td>

													<td>
														<div class="hidden-sm hidden-xs btn-group">
															
															<?php
			echo '<a href="'.base_url().'admin/edit_operator/'.$op['id_operator'].'" rel="example_group"  class="btn btn-xs btn-info" role="button" <span><i class="ace-icon fa fa-pencil-square-o bigger-120"></i><span></a>
				<a href="'.base_url().'admin/hapus_operator/'.$op['id_operator'].'"
