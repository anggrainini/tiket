...
<html lang="en">
	...
	<a href="<?php echo base_url(); ?>admin/tambah_jadwal" class="btn btn-success btn-xs" role="button">Add Jadwal <span class="glyphicon glyphicon-plus"></span></a>
					...
					;?> 
													...
													<td>
														<div class="hidden-sm hidden-xs btn-group">
															...
															<?php
			echo '<a href="'.base_url().'admin/edit_jadwal/'.$op['id_jadwal'].'" rel="example_group"  class="btn btn-xs btn-info" role="button" <span><i class="ace-icon fa fa-pencil-square-o bigger-120"></i><span></a>
				<a href="'.base_url().'admin/detail_jadwal/'.$op['id_jadwal'].'" rel="example_group"  class="btn btn-xs btn-warning" role="button" <span><i class="fa fa-usd"></i><span></a>
				<a href="'.base_url().'admin/hapus_jadwal/'.$op['id_jadwal'].'"
