<?php
  $id_admin          = $name_admin->id_admin;
if($this->input->post('is_submit')){
   
  $username         = set_value('id_admin');
  ...
  $username     = $name_admin->id_admin;
  $password 	= $name_admin->password;
  $nama   		= $name_admin->nama;
  $alamat     	= $name_admin->alamat;
  $no_hp 		= $name_admin->no_hp;
  $img 			= $name_admin->img;
															...
															<div class="row">	
																<div class="col-xs-12 col-sm-8">
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<input class="col-xs-12 col-sm-10" type="text" name="username" id="username" placeholder="Username" disabled="disabled" value="<?php echo $username ?>" />
																		</div>
																	</div>
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<input class="col-xs-12 col-sm-10" type="text" id="password" name="password" placeholder="Password" value="<?php echo $password ?>" />
																		</div>
																	</div>
																	...
																	<div class="space-4"></div>
																		...
																		<div class="col-sm-8">
																			<input class="col-xs-12 col-sm-10" type="text" name="nama" id="nama" placeholder="Nama" value="<?php echo $nama ?>" />
																		</div>
																	</div>
																	...
																	<div class="space-4"></div>
																		...
																		<div class="col-sm-8">
																			<input class="col-xs-12 col-sm-10" type="text" name="alamat" id="alamat" placeholder="Alamat" value="<?php echo $alamat ?>" />
																		</div>
																	</div>
															...
															<div class="form-group">
																...
																<div class="col-sm-8">
																	<span class="input-icon input-icon-right">
																		<input class="input-medium input-mask-phone" type="text" name="phone" id="phone" value="<?php echo $no_hp ?>" />
