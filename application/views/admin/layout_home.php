...
<html lang="en">
	...
	<body class="no-skin">
	 ...
	 <?php
		foreach($data_admin->result_array() as $op)
		{
		?>
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="<?php echo base_url(); ?>admin/report_pemesanan">
					...
					<li class="">
						...
						<b class="arrow"></b>
								...
								<ul class="submenu">
									...
									<li class="">
										<a href="<?php echo base_url(); ?>admin/tambah_tim">
											<i class="menu-icon fa fa-caret-right"></i>
											Add Tim
										</a>
					...
					<li class="">
						...
						<b class="arrow"></b>
								...
								<ul class="submenu">
									...
									<li class="">
										<a href="<?php echo base_url(); ?>admin/tambah_jadwal">
											<i class="menu-icon fa fa-caret-right"></i>
											Add Jadwal
										</a>
					...
					<li class="">
						...
						<b class="arrow"></b>
								...
								<ul class="submenu">
									...
									<li class="">
										<a href="<?php echo base_url(); ?>admin/tambah_member">
											<i class="menu-icon fa fa-caret-right"></i>
											Add Member
										</a>
					...
					<li class="">
						...
						<b class="arrow"></b>
								...
								<ul class="submenu">
									...
									<li class="">
										<a href="<?php echo base_url(); ?>admin/tambah_operator">
											<i class="menu-icon fa fa-caret-right"></i>
											Add Operator
										</a>
					...
					<li class="">
						<a href="" class="dropdown-toggle">
							...
							<span class="menu-text"> Eksekutif </span>
						</a>
						...
						<b class="arrow"></b>
								...
								<ul class="submenu">
									<li class="">
										<a href="<?php echo base_url(); ?>admin/eksekutif">
											<i class="menu-icon fa fa-caret-right"></i>
											View Eksekutif
										</a>
									...
									<li class="">
										<a href="<?php echo base_url(); ?>admin/tambah_eksekutif">
											<i class="menu-icon fa fa-caret-right"></i>
											Add Eksekutif
										</a>
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="<?php echo base_url(); ?>admin/<?php echo $pointer; ?>"><?php echo $main_bread; ?></a>
							</li>
