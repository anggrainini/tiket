...
<html lang="en">
	...
	<a href="<?php echo base_url(); ?>admin/tambah_eksekutif" class="btn btn-success btn-xs" role="button">Add Eksekutif <span class="glyphicon glyphicon-plus"></span></a>
												...
												<tr>
													...
													<td>
														<div class="hidden-sm hidden-xs btn-group">
															...
															<?php
			echo '<a href="'.base_url().'admin/edit_eksekutif/'.$op['id_eksekutif'].'" rel="example_group"  class="btn btn-xs btn-info" role="button" <span><i class="ace-icon fa fa-pencil-square-o bigger-120"></i><span></a>
				<a href="'.base_url().'admin/hapus_eksekutif/'.$op['id_eksekutif'].'"
			...
			?>
												...
												<?php
												 ...
												 ;?> 
																		...
																		<br />
																		<div class="width-120 label label-info label-xlg arrowed-in arrowed-in-right">
																	...
																	<div class="profile-user-info profile-user-info-striped">
																		<div class="profile-info-row">
																			...
																			<div class="profile-info-value">
																				<span><?php echo $op['id_eksekutif']; ?></span>
																			</div>
																		</div>
