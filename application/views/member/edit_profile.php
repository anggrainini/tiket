<!--<?php
  $id_member          = $name_admin->id_member;
...
<?php echo form_open_multipart("member/edit_profile");?>
													...
													<div class="tab-content profile-edit-tab-content">
														<div id="edit-basic" class="tab-pane in active">
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-8">
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<input class="col-xs-12 col-sm-10" type="text" name="username" id="username" placeholder="Username" disabled="disabled" value="<?php echo $op['id_member']; ?>" />
																		</div>
																	</div>
															...
															<div class="form-group">
																...
																<div class="col-sm-8">
																	<span class="input-icon input-icon-right">
																		<input class="input-medium input-mask-email" type="text" name="email" id="email" value="<?php echo $op['email']; ?>" />
																		<i class="ace-icon fa fa-email fa-flip-horizontal"></i>
																	</span>
																</div>
															</div>
