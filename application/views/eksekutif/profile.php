		...
		<![endif]-->
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<!--
<?php
  $id_eksekutif      = $data_eksekutif->id_eksekutif;
if($this->input->post('is_submit')){
   
  $id_eksekutif      = set_value('id_eksekutif');
  ...
  $id_eksekutif  = set_value('id_eksekutif');
  $password 	= $data_eksekutif->password;
  $nama   		= $data_eksekutif->nama;
  $alamat     	= $data_eksekutif->alamat;
  $no_hp 		= $data_eksekutif->no_hp;
  $img 			= $data_eksekutif->img;
										...
										<div class="col-xs-12 col-sm-9">
											<div class="center">
												<span class="btn btn-app btn-sm btn-light no-hover">
													<span class="line-height-1 bigger-170 blue"> E </span>
													<br />
													</span>

												<span class="btn btn-app btn-sm btn-yellow no-hover">
													<span class="line-height-1 bigger-170"> K </span>
													<br />
													</span>
												...
												<span class="btn btn-app btn-sm btn-red no-hover">
													<span class="line-height-1 bigger-170"> U </span>

													<br />
													</span>
												<span class="btn btn-app btn-sm btn-warning no-hover">
													<span class="line-height-1 bigger-170"> T </span>

													<br />
													</span>
												<span class="btn btn-app btn-sm btn-pink no-hover">
													<span class="line-height-1 bigger-170"> I </span>

													<br />
													</span>
													</span>
												<span class="btn btn-app btn-sm btn-yellow no-hover">
													<span class="line-height-1 bigger-170"> F </span>
