...
<?php echo form_open_multipart("operator/edit_profile");?>
															...
															<div class="row">	
																<div class="col-xs-12 col-sm-8">
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<input class="col-xs-12 col-sm-10" type="text" name="username" id="username" placeholder="Username" disabled="disabled" value="<?php echo $op['id_operator'] ?>" />
																		</div>
																	</div>
