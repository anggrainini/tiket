...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>User Profile Page - Operator</title>
...
if($this->input->post('is_submit')){
  ...
  $id_operator  = set_value('id_operator');
  $password 	= $data_operator->password;
  $nama   		= $data_operator->nama;
  $alamat     	= $data_operator->alamat;
  $no_hp 		= $data_operator->no_hp;
  $img 			= $data_operator->img;
										...
										<div class="col-xs-12 col-sm-9">
											<div class="center">
												<span class="btn btn-app btn-sm btn-light no-hover">
													<span class="line-height-1 bigger-170 blue"> O </span>
													<br />
													</span>

												<span class="btn btn-app btn-sm btn-yellow no-hover">
													<span class="line-height-1 bigger-170"> P </span>
													<br />
													</span>
												...
												<span class="btn btn-app btn-sm btn-success no-hover">
													<span class="line-height-1 bigger-170"> A </span>
												...
												<span class="btn btn-app btn-sm btn-gold no-hover">
													<span class="line-height-1 bigger-170"> O </span>
